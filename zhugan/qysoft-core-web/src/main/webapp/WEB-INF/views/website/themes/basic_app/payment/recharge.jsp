            ...
            <div class="aui-list-item-inner">
                <label style="width:100%;">
                    <div class="aui-list-item-label aui-pull-left" style="width:70%;line-height: inherit">
                        <img src="${ctxStatic}/images/pic-zhifubao.png" style="width:2rem;"/><span>支付宝扫码支付</span>
                    </div>
                    <div class="aui-list-item-input aui-pull-right" style="width:30%;">
                        <input class="aui-radio aui-pull-right" type="radio" name="payMode" checked value="lianlianPay">
                    </div>
                </label>
            </div>
        </li>
...
<script type="text/javascript">
    ...
    function initView() {
        ...
        $('#pay').on('click', function () {
            ...
            if ($("input[name='payMode']:checked").val() == 'aliPay') {
                ...
                wechatPay(money);
            }else if ($("input[name='payMode']:checked").val() == 'lianlianPay') {
                lianlianPay(money);
            } else {
                huanxunPay(money);
            }
    ...
    function  lianlianPay(money) {
        window.location.href="${ctxFront}/payment/pay/lianlianPay";
    }
