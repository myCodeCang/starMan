...
public class UserReportService extends CrudService<UserReportDao, UserReport> {
    ...
    public Page<UserReport> sumStarReportPage(Page<UserReport> userReportPage, UserReport userReport) {
        userReport.setPage(userReportPage);
        userReportPage.setList(dao.sumStarReport(userReport));
