    ...
    <div class="container-small am-cf">
        <div class="row">
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 日持仓查询
                ...
                <div class="widget am-cf">
                    <div class="widget-head am-cf">
                        <div class="widget-body am-fr">
                            ...
                            <form:form id="searchForm" modelAttribute="everydayHold" action="${ctx}/user/userDayHoldGoods/" method="post" class="am-form tpl-form-border-form tpl-form-border-br am-form-inline">
                                ...
                                <div class="am-form-group am-form-icon ">
                                    <input name="createDateTimeBegin" type="date"  htmlEscape="false" maxlength="100" class="input-medium" value="<fmt:formatDate value="${everydayHold.createDateTimeBegin}" pattern="yyyy-MM-dd"/>"/>
                                </div>
                                --
                                <div class="am-form-group am-form-icon ">
                                    <input name="createDateTimeEnd" type="date"  htmlEscape="false" maxlength="100" class="input-medium" value="<fmt:formatDate value="${everydayHold.createDateTimeEnd}" pattern="yyyy-MM-dd"/>"/>
                                </div>
                                <div class="am-form-group am-form-icon ">
