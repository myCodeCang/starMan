...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/user/userStarReport/starReport">用户资产报表</a></li>
	...
	<form:form id="searchForm" modelAttribute="userReport"
		action="${ctx}/user/userStarReport/starReport" method="post"
		...
		<ul class="ul-form">
			...
			<%--</li>--%>
			<li><label>充值额度：</label> <form:input path="buyBonus" htmlEscape="false" maxlength="100" class="input-medium" />
			</li>
			<li><label>手续费额度：</label> <form:input path="applyBonus" htmlEscape="false" maxlength="100" class="input-medium" />
			</li>
			<li><label>时间：</label>
