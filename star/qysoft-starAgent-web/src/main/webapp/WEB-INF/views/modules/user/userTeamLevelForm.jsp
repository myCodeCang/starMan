...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/help/userTeamLevel/">代理级别列表</a></li>
		<li class="active"><a href="${ctx}/help/userTeamLevel/form?id=${userTeamLevel.id}">代理级别<shiro:hasPermission name="user:userTeamLevel:edit">${not empty userTeamLevel.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="user:userTeamLevel:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="userTeamLevel" action="${ctx}/help/userTeamLevel/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
