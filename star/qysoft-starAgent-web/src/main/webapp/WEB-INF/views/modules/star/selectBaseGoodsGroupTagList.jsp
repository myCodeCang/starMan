...
<body>
	...
	<form:form id="searchForm" modelAttribute="baseGoodsGroup" action="${ctx}/star/baseGoodsGroup/selectGoods" method="post" class="breadcrumb form-search">
	...
	<table id="searchUserTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="baseGoodsGroup">
			...
			<tr onclick="selectUser(this)" data2="${baseGoodsGroup.name}" data="${baseGoodsGroup.id}" ondblclick="doubleSelectUser(this)" style="cursor: pointer;" onmouseover="mouseOver(this)" onmouseout="mouseOut(this)" >
