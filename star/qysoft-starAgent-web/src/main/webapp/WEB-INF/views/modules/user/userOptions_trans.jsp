    ...
    <div class="layui-tab-content">
        ...
        <div class="layui-tab-item layui-show">
            ...
            <form name="inputForm" modelAttribute="optionValue"
                ...
                <div class="control-group">
                    <label class="control-label">转让最高价限制比例：</label>
                    <div class="controls">
                        <input type="text" name="attorn_price"
                               value="${options.system_trans.attorn_price }" htmlEscape="false"
                               class="input-xlarge required"/>
                        <span class="help-inline"><font
                                color="red">*</font> 标识:[attorn_price] </span>
                    </div>
                </div>
                <div class="control-group">
