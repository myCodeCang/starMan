...
<body>
	...
	<form:form id="inputForm" modelAttribute="userUserinfo" action="${ctx}/user/userUserinfo/save" method="post" class="form-horizontal">
		...
		<%--<c:if test="${userUserinfo.isUsercenter=='0'}">--%>
			<%--<div class="control-group">--%>
				<%--<label class="control-label">用户代理等级:</label>--%>
				<%--&lt;%&ndash;<div class="controls">&ndash;%&gt;--%>
					<%--&lt;%&ndash;<input name="LevelName" htmlEscape="false" maxlength="60" class="input-xlarge " value="${userUserinfo.userLevel.levelName}" type="text" readonly/>&ndash;%&gt;--%>
				...
				<%--<div class="controls">--%>
					<%--<form:select path="userType" class="input-xlarge required">--%>
						...
						<%--<form:options items="${userTeamLevels}" itemLabel="teamName" itemValue="teamCode" htmlEscape="false" />--%>
					<%--</form:select>--%>
					<%--<span class="help-inline"><font color="red">*</font> </span>--%>
				<%--</div>--%>
			<%--</div>--%>
