            ...
            $("#btnExport").click(function(){
                top.$.jBox.confirm("确认要导出用户数据吗？","系统提示",function(v,h,f){
                    if(v=="ok"){
                        ...
                        $("#searchForm").submit();
                        $("#searchForm").attr("action","${ctx}/user/userWithdraw/");
                    }
                },{buttonsFocus:1});
		...
		<tr>
			...
			<td>
				<c:if test="${userWithdraw.status==0}">
					<a class="layui-btn layui-btn-mini layui-btn-normal" href="${ctx}/user/userUserinfo/check?id=${userWithdraw.id}"
					   onclick="layui.qyframe.openPromptMsg('提现审核','是否同意','${userWithdraw.userName}',[{'label':'是','value':'1'},{'label':'否','value':'0'}],'1',this.href);return  false;">打款</a>
				</c:if>
