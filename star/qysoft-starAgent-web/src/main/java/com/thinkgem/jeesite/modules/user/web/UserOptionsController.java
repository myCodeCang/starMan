...
public class UserOptionsController extends BaseController {
    ...
    @RequiresPermissions("user:userOptions:view")
    @RequestMapping(value = {"ejfx"})
    public String ejfx(String groupName, @RequestParam(required = false) String optLabel, Model model, RedirectAttributes redirectAttributes) {
        ...
        if (optionsMap.size() == 0) {
            addMessage(redirectAttributes, "读取配置失败!");
            return "modules/user/userOptions_ejfx";
        }
    ...
    @RequiresPermissions("user:userOptions:edit")
    @RequestMapping(value = "saveEjfxGroup")
    public String saveEjfxGroup(UserOptions userOptions, Model model, RedirectAttributes redirectAttributes, @RequestParam Map<String, String> params) throws ValidationException {
        if (!beanValidator(model, userOptions)) {
        ...
        return "redirect:" + Global.getAdminPath() + "/user/userOptions/ejfx?groupName=" + userOptions.getGroupName() + "&optLabel=" + userOptions.getOptionName();
    }
    ...
    public String mdConfig(String groupName, @RequestParam(required = false) String optLabel, Model model, RedirectAttributes redirectAttributes) {
    ...
    @RecordLog(logTitle = "明星配置-交易配置-撮合交易配置")
    @RequiresPermissions("user:userOptions:edit")
    @RequestMapping(value = "savemdConfig")
    public String savemdConfig(UserOptions userOptions, Model model, RedirectAttributes redirectAttributes, @RequestParam Map<String, String> params) throws ValidationException {
        if (!beanValidator(model, userOptions)) {
        ...
        return "redirect:" + Global.getAdminPath() + "/user/userOptions/mdConfig?groupName=" + userOptions.getGroupName() + "&optLabel=" + userOptions.getOptionName();
    }
}