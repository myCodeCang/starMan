...
public class UserTeamLevel extends DataEntity<UserTeamLevel> {
	...
	//拓展字段
	private String teamCodeBegin;


	public String getTeamCodeBegin() {
		return teamCodeBegin;
	}

	public void setTeamCodeBegin(String teamCodeBegin) {
		this.teamCodeBegin = teamCodeBegin;
	}
